...
const userslistTpl = await _.loadHTML("/admin/templates/userslist.html", { raw: true });
const errorslistTpl = await _.loadHTML("/admin/templates/errorslist.html", { raw: true });
