...
export const REMAPPERS = {
	// The flat EmitterConfig (pixi-particle-system) uses listData: { list: [{time, value}, ...] } arrays.
	// assignRecursive merges arrays index-wise, which would leave stale base entries when an override list is shorter
	// (e.g. particleDefaults' 2-entry color list bleeding into a 4-7 entry component config).
	// This replaces the whole list instead.
