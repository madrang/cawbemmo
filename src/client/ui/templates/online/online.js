...
const template = await _.loadHTML("/ui/templates/online/template.html", { raw: true });
const templateListItem = await _.loadHTML("/ui/templates/online/templateListItem.html", { raw: true });
